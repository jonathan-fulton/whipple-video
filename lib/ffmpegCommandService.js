...
class FfmpegCommandService {
    ...
    _createCommandSchema(outputRequired = true) {
        ...
        const whippleCommandOutput = Joi.object().keys({
            ...
            dimensions: whippleCommandDimensionsOptional.optional()
        });
    ...
    _mapCommandToArrayFormat(command) {
        ...
        ['video', 'audio', 'backgroundOverlay', 'imageOverlay', 'textOverlay', 'output'].forEach(prop => {
    ...
    _createFfmpegCommand(command) {
        ...
        // 5) Add output filename and output dimensions
