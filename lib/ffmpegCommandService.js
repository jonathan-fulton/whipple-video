...
class FfmpegCommandService {
    ...
    _createFilterForTextOverlay(textOverlay, i) {
        ...
        const x = this._calculateHorizontalPosition(textOverlay.xLoc);
        const y = this._calculateVerticalPosition(textOverlay.yLoc);
    ...
    _calculateHorizontalPosition(x) {
        switch (x) {
            case 'left':
                return 0;
