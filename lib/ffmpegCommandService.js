...
class FfmpegCommandService {
    ...
    _createCommandSchema() {
        ...
        const whippleCommandSchema = Joi.object().keys({
            ...
            backgroundOverlay: Joi.alternatives().try([whippleCommandBackgroundOverlaySchema, Joi.array().items(whippleCommandBackgroundOverlaySchema).min(1)]),
            imageOverlay: Joi.alternatives().try([whippleCommandImageOverlaySchema, Joi.array().items(whippleCommandImageOverlaySchema).min(1)]),
 ...
 * @property {number} [trimStart] - in seconds; must be between 0 and 600
 * @property {number} [trimDuration] - in seconds; must be between 0 and 600
